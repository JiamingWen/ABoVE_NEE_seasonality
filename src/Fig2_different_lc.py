...
for lcname, color in zip(['forest', 'shrub', 'tundra'], ["#05450a", "#c6b044", "#ffafdc"]):
    ...
    fitting_df_UpscaledEC_merge = pd.merge(fitting_df_UpscaledEC_sorted, fitting_df_UpscaledEC_unscaled_lc, on='model_name', how='outer', suffixes=('_all', '_lc'))
    ...
    plt.scatter(fitting_df_UpscaledEC_merge[f'{stat_var}_lc'], fitting_df_UpscaledEC_merge['model_name'], marker='o', color=color, facecolors='none', s=70)

...
input_dir = f'/central/groups/carnegie_poc/jwen2/ABoVE/modis_fpar/data_{year}'
...
ds_monthly.to_netcdf(
    f"/central/groups/carnegie_poc/jwen2/ABoVE/modis_fpar/{varname}-500m-monthly-{year}04-{year}11.nc",
    engine="netcdf4",

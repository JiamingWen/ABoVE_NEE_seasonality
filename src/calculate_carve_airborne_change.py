...
data_background = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/carve_airborne/ABoVE_{year}_carve_airborne_background.csv')
...
CO2_change_df.to_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/carve_airborne/ABoVE_{year}_carve_airborne_change.csv', encoding='utf-8', index=False)
...
# import pandas as pd
# CO2_change_df = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/carve_airborne/ABoVE_{year}_carve_airborne_change.csv')

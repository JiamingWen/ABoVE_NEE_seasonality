...
def read_remote_sensing (data_name, var_name, year, month):
    ...
    if data_name == 'par':
        ...
        f = f"/central/groups/carnegie_poc/jwen2/ABoVE/modis_fpar/{var_name}-half-degree-monthly-{year}04-{year}11.nc"
...
def read_GOME2_SIF (var_name, year, month):
    ...
    f = f"/central/groups/carnegie_poc/jwen2/ABoVE/gome2/gome2_monthly_2012_2017_CF08.nc"

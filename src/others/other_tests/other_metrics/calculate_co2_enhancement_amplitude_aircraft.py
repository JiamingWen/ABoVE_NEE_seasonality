...
for year in [2012, 2013, 2014, 2017]:
    ...
    df_year_cp_monthly.to_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft_{year}{seasonal}{background}.csv', index=False)
...
df_combined_monthly.to_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft{seasonal}{background}.csv', index=False)


'''plot sensonal co2 enhancement amplitude for aircraft data during 2012-2014 and 2017'''
df_combined_monthly = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft{seasonal}{background}.csv')
df_combined_monthly_2012 = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft_2012{seasonal}{background}.csv')
df_combined_monthly_2013 = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft_2013{seasonal}{background}.csv')
df_combined_monthly_2014 = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft_2014{seasonal}{background}.csv')
df_combined_monthly_2017 = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/other_metrics/seasonal_amplitude/seasonal_co2_enhancement_amplitude_aircraft_2017{seasonal}{background}.csv')

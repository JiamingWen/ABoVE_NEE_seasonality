'''
This script generates Fig. S5 in SI.
It compares the correlation with observed CO2 for using all data vs using only afternoon data, for TRENDYv11 TBMs, upscaled EC datasets, atmospheric inversions and remote sensing references.
'''
...
# unscaled variables (without linear regression)
fitting_df_TRENDYv11_unscaled_afternoon = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_TRENDYv11{lc_filestr}_afternoon.csv')
...
fitting_df_inversions_unscaled_afternoon = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_inversionsNEE{lc_filestr}_afternoon.csv')
...
fitting_df_UpscaledEC_unscaled_afternoon = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_UpscaledEC{lc_filestr}_afternoon.csv')

# scaled variables (with linear regression)
fitting_df_reference_scaled_afternoon = pd.read_csv(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_scaled_reference{lc_filestr}_afternoon.csv')
...
results = OLSResults.load(f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/regression/TRENDYv11_CLM5.0{lc_filestr}_afternoon.pickle")
n = results.summary2().tables[0].loc[3,1] # number of observations
...
fig.savefig('/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/figures/Fig2_afternoon.png', dpi=300, bbox_inches='tight')
fig.savefig('/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/figures/Fig2_afternoon.pdf', dpi=300, bbox_inches='tight')
plt.show()
'''
extract the background CO2 concentration for each day using 3,000 m as cutoff value, 
and compare with the background CO2 concentration using 2,000 m as cutoff value
'''
...
plt.savefig('/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_background/compare_background_2k_3k.png', dpi=300, bbox_inches='tight')
plt.show()
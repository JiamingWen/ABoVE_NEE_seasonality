...
if __name__ == "__main__":
    ...
    for campaign_name, year in [("carve", 2012), ("carve", 2013), ("carve", 2014), ("arctic_cap", 2017)]:
        ...
        if campaign_name == "carve":
            traj_path = f"/resnick/groups/carnegie_poc/michalak-lab/nasa-above/data/input/footprints/carve-trajectories/CARVE_L4_WRF-STILT_Particle/data/CARVE-{year}-aircraft-particle-files-convect"
        else:
            traj_path = f"/resnick/groups/carnegie_poc/michalak-lab/nasa-above/data/input/footprints/above-trajectories/ABoVE_Particles_WRF_AK_NWCa/data/ArcticCAP_2017_insitu-particles"
        ...
        extract_endpts_co2_ct_airborne(
            ...
            traj_path,
            f"/resnick/groups/carnegie_poc/michalak-lab/nasa-above/data/input/background/co2/carbontracker-2022",
        ...
        calculate_ebg_co2_airborne(
            f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/{campaign_name}_airborne/atm_obs/ABoVE_{year}_{campaign_name}_airborne_matching_footprint.csv",
            traj_path,
            f"/resnick/groups/carnegie_poc/michalak-lab/data/noaa-gml-na-boundary-conditions/v20200302/nc/ebg_co2.nc",

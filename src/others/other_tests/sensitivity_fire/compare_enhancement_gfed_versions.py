...
plt.savefig(f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_fire/gfed_versions_scatterplot.png", dpi=100, bbox_inches='tight')
plt.show()
...
dir0 = '/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/seasonality_adjustment/'
...
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/seasonality_adjustment/Fig4_diurnal_x_base.png', dpi=300, bbox_inches='tight')
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/seasonality_adjustment/Fig4_diurnal_x_base.pdf', dpi=300, bbox_inches='tight')
plt.show()
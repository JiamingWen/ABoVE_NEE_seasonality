'''aggregate inversions (CT-NOAA, CTE) from 3-hourly to daily and monthly'''
...
if inversion_name == "CT-NOAA":
    ...
    dir_3hourly: str = "/resnick/groups/carnegie_poc/michalak-lab/data/inversions/inversion_dif_tem_res/global-half-degree/CTE/three-hourly/"
    varname: str = ["co2_bio_flux_opt"]
    filestr = "bio_"


dir_3hourly = f'/resnick/groups/carnegie_poc/michalak-lab/data/inversions/inversion_dif_tem_res/global-half-degree/{inversion_name}/three-hourly/'
dir_daily = f'/resnick/groups/carnegie_poc/michalak-lab/data/inversions/inversion_dif_tem_res/global-half-degree/{inversion_name}/daily/'
dir_monthly = f'/resnick/groups/carnegie_poc/michalak-lab/data/inversions/inversion_dif_tem_res/global-half-degree/{inversion_name}/monthly/'

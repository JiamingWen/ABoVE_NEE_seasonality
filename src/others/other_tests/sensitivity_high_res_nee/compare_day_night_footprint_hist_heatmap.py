...
plt.text(0.05, 0.95, f"mean: {mean_diff:.2f}", transform=plt.gca().transAxes,
            fontsize=16, verticalalignment='top', color='black')
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/day_night_footprint_difference_histogram.png', dpi=300)
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/day_night_footprint_difference_histogram.pdf', dpi=300)
plt.show()
...
plt.text(0.05, 0.95, f"mean: {int(mean_diff_frac*100)}%", transform=plt.gca().transAxes,
            fontsize=16, verticalalignment='top', color='black')
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/day_night_footprint_difference_percent_histogram.png', dpi=300)
plt.savefig(f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/day_night_footprint_difference_percent_histogram.pdf', dpi=300)
plt.show()

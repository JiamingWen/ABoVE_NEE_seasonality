...
ds_daytime_all.to_netcdf(
    f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/footprint_daytime_nightime/influence_mean_daytime_allyears_selected.nc',
    engine="netcdf4",
...
ds_nighttime_all.to_netcdf(
    f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/footprint_daytime_nightime/influence_mean_nighttime_allyears_selected.nc',
    engine="netcdf4",
...
dir = '/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/footprint_daytime_nightime'
...
plt.savefig('/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/footprint_daytime_nightime/footprint_daytime_nighttime_map.png', dpi=300, bbox_inches='tight')
plt.show()
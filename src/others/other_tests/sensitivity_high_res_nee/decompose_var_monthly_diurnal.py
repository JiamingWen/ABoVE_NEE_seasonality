'''decompose the variance of modeled CO2 enhancements due to NEE seasonal and diurnal cycles'''
...
plt.tight_layout()
plt.savefig('/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/decompose_var_monthly_diurnal.png', dpi=300)
plt.show()

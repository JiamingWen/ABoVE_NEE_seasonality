...
for model_type in model_types:
    ...
    if model_type in ['CT-NOAA', 'CTE', 'X-BASE']:
        plt.savefig(f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/evaluation_stat_{model_type}{lc_filestr}_highres_scatterplot.png", dpi=100, bbox_inches='tight')
        plt.savefig(f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_high_res_nee/evaluation_stat_{model_type}{lc_filestr}_highres_scatterplot.pdf", dpi=100, bbox_inches='tight')
    plt.show()

...
# unscaled variables (without linear regression)
fitting_df_TRENDYv11_unscaled_gfed5 = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_TRENDYv11{lc_filestr}_gfed5.csv')
...
fitting_df_inversions_unscaled_gfed5 = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_inversionsNEE{lc_filestr}_gfed5.csv')
...
fitting_df_UpscaledEC_unscaled_gfed5 = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_unscaled_UpscaledEC{lc_filestr}_gfed5.csv')

# scaled variables (with linear regression)
fitting_df_reference_scaled_gfed5 = pd.read_csv(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/evaluation_stat/evaluation_stat_scaled_reference{lc_filestr}_gfed5.csv')
fitting_df_reference_scaled_gfed5 = fitting_df_reference_scaled_gfed5.loc[fitting_df_reference_scaled_gfed5['model_name'].isin(['APAR', 'GOME2_SIF']), :]  #'APAR', 'FPAR', 'LAI', 'PAR'
fitting_df_reference_scaled_gfed5.loc[fitting_df_reference_scaled_gfed5['model_name'] == 'GOME2_SIF','model_name'] = 'SIF'
...
fitting_df_reference_merge = pd.merge(fitting_df_reference_scaled, fitting_df_reference_scaled_gfed5, on='model_name', how='outer', suffixes=('_gfed4.1', '_gfed5'))
...
plt.scatter(fitting_df_reference_merge[f'{stat_var}_gfed5'], fitting_df_reference_merge['model_name'], marker='o', color=color, facecolors='none', s=70)

plt.legend(bbox_to_anchor=(0.1, 0.7), fontsize=14)

fig.savefig('/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_test_fire/Fig2_gfed5.png', dpi=300, bbox_inches='tight')
fig.savefig('/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_test_fire/Fig2_gfed5.pdf', dpi=300, bbox_inches='tight')
plt.show()
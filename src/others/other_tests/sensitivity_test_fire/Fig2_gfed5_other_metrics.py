...
fig.savefig(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_test_fire/Fig2_gfed5_other_metrics_{stat_var}.png', dpi=300, bbox_inches='tight')
fig.savefig(f'/central/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/result/other/sensitivity_test_fire/Fig2_gfed5_other_metrics_{stat_var}.pdf', dpi=300, bbox_inches='tight')
plt.show()
...
def regrid_fpar_lai(varname, year) -> None:
    ...
    # read the data
    filename1 = f'/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/modis_fpar/{varname}-500m-monthly-{year}04-{year}11.nc'
    ...
    f_o: str = (
        f"/resnick/groups/carnegie_poc/jwen2/ABoVE/ABoVE_NEE_seasonality/data/modis_fpar/{varname}-half-degree-monthly-{year}04-{year}11.nc"
    )
